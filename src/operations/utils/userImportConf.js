...
export const transformUserData = data => {
  return data.map(element => {
    element.entrance_datetime && (element.entrance_datetime = excelDateToJsDate(element.entrance_datetime))
    element.birth_date && element.birth_date && (element.birth_date = excelDateToJsDate(element.birth_date))
