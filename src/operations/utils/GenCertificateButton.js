...
export function GenCertificateButton({ studentId }) {
    ...
    const generate = useCallback(() => {
      notify('Certificat de scolarité en cours de téléchargement', { autoHideDuration: 5000 })
      studenstFileApi()
        ...
        .catch(() => notify('Échec de téléchargement. Veuillez réessayer', { autoHideDuration: 5000 }))
    },[studentId])
