...
export const ProfileLayout = () => {
  ...
  const addressGPSRenderer = user => {
    if (user.addressGps === undefined) return 'No GPS location found'
    return user.addressGps
  }
  ...
  return (
    <SimpleShowLayout>
      ...
      <FunctionField label='GPS' render={addressGPSRenderer} />
