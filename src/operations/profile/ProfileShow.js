...
import { Link, Button, Dialog, DialogTitle, DialogContent, DialogActions } from '@mui/material'
...
export const ProfileLayout = () => {
  ...
  const LocalisationRenderer = () => {
    return (
      <>
        <Button variant='outlined' startIcon={<LocationOnOutlinedIcon />} onClick={handleClickOpen}>
          Localisation
        </Button>
        <Dialog open={open} onClose={handleClose} fullWidth maxWidth='md'>
          ...
          <DialogContent>
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <ErrorOutlineOutlinedIcon color='error' style={{ marginRight: '8px' }} />
