...
const EMBED_FRAME_CLASS = "documenso-embed-frame";
const ALERT_SX = {mb: 2};
const FALLBACK_SX = {display: "flex", justifyContent: "flex-end", px: 2, py: 1};
          ...
          <>
            ...
            <Box sx={FALLBACK_SX}>
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                data-testid="open-on-documenso-link"
                variant="body2"
              >
                Ouvrir sur Documenso
              </Link>
            </Box>
            <Box sx={EMBED_SX}>
              <EmbedSignDocument
