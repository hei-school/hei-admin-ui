        ...
        >
            <SimpleForm>
                ...
                {isPredefinedFirstDueDate ? (
                    ...
                    <DateInput source='manual_first_duedate' name= "manual_first_duedate" label='Première date limite manuelle' fullWidth={true}
                               validate={required()}/>
                )}
            </SimpleForm>
        </Create>
...
const FeesConfInput = ({isPredefinedType, feesConf}) => {
    ...
    return (
        <div>
            <TextInput source='monthly_amount' name= "monthly_amount" label='Montant de la mensualité' fullWidth={true}
                       disabled={isPredefinedType} validate={validateMonthlyAmount}/>
            <TextInput source='months_number' name="months_number" label='Nombre de mensualités' fullWidth={true} disabled={isPredefinedType}
