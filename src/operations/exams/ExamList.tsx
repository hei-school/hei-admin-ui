            ...
            >
              ...
              <CardContent sx={{ padding: "16px" }}>
                ...
                >
                  ...
                  Enseignant: {exam.awarded_course?.main_teacher?.first_name} {exam.awarded_course?.main_teacher?.last_name}
                </Typography>
                <Typography
                  sx={{
                    marginBottom: "12px",
                ...
                >
                  <CalendarIcon sx={{ fontSize: '1.5rem', marginRight: '10px', color: PALETTE_COLORS.red }} />
