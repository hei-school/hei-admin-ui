...
import {
  transcript1Mock,
  transcriptsMock,
  transcriptsVersion1Mock,
  transcriptsVersionMock
} from './mocks/responses/transcripts-api'
...
describe(specTitle('Transcripts'), () => {
  ...
  it('can details each transcript', () => {
    ...
    cy.intercept('GET', `/students/${student1Mock.id}/transcripts/${transcript1Mock.id}/versions?page=1&page_size=10`, transcriptsVersionMock).as('getTranscriptVersions')
