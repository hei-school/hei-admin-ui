...
export const predefinedFirstDueDates = {
  ...
  date1: {
    name: `15 octobre ${currentYear}`,
    value: new Date(currentYear, 9, 15),
  },
  date2: {
    name: `15 janvier ${currentYear + 1}`,
    value: new Date(currentYear + 1, 0, 15),
  },
