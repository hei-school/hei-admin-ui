...
/**
    ...
    * @enum {string}
    */
export enum StudentTranscriptClaimStatusEnum {
    Open = 'OPEN',
    Close = 'CLOSE'
}
...
/**
    ...
    * @enum {string}
    */
export enum TranscriptSemesterEnum {
    S1 = 'S1',
    S2 = 'S2',
    S3 = 'S3',
    S4 = 'S4',
...
export const TranscriptApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        putStudentTranscriptVersionPdf: async (studentId: string, transcriptId: string, body: any, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'studentId' is not null or undefined
...
export const TranscriptApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getStudentTranscriptVersionPdf(studentId: string, transcriptId: string, versionId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<any>> {
         ...
         * @throws {RequiredError}
         */
        async putStudentTranscriptVersionPdf(studentId: string, transcriptId: string, body: any, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<StudentTranscriptVersion>> {
...
export const TranscriptApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getStudentTranscriptVersionPdf(studentId: string, transcriptId: string, versionId: string, options?: any): AxiosPromise<any> {
         ...
         * @throws {RequiredError}
         */
        putStudentTranscriptVersionPdf(studentId: string, transcriptId: string, body: any, options?: any): AxiosPromise<StudentTranscriptVersion> {
...
export class TranscriptApi extends BaseAPI {
     ...
     * @memberof TranscriptApi
     */
    public putStudentTranscriptVersionPdf(studentId: string, transcriptId: string, body: any, options?: AxiosRequestConfig) {
