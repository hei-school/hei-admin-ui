...
export const TeachingApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        moveOrDeleteStudentInGroup: async (id: string, createGroupFlow: CreateGroupFlow, page?: number, pageSize?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'id' is not null or undefined
...
export const TeachingApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getAwardedCoursesByIdAndGroupId(groupId: string, awardedCourseId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<ExamInfo>>> {
         ...
         * @throws {RequiredError}
         */
        async moveOrDeleteStudentInGroup(id: string, createGroupFlow: CreateGroupFlow, page?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GroupFlow>> {
