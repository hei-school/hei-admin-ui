import {announcement1, announcementCreate, announcementsMock, createdAnnouncement} from "../fixtures/api_mocks/announcement-mocks";
...
describe("Manager announcements", () => {
    beforeEach(() => {
        ...
        cy.intercept('GET', `/announcements?page=1&page_size=10`, announcementsMock).as("getAnnouncements");
    ...
    it("can create an announcement", () => {
        ...
        cy.get('.toastui-editor-ww-container > .toastui-editor > .ProseMirror').type(announcementCreate?.content!).as("Type the announcement content");

        cy.intercept('GET', `/announcements/${createdAnnouncement.id}`, createdAnnouncement);
